...
import { RelationFiltersCompact } from '@/components/admin/relations/relation-filters-compact';
...
export function RelationsPageContent() {
  ...
  const handleEgoNetworkClick = (email: string) => {
    ...
    setSelectedNode(null); // Fermer le panneau de détails
    toast({
