...
VALUES
  ...
  ('demo-event-budget-revenue-001', 'demo-event-001', NULL, NULL, NULL, NULL, NULL, NULL, 'demo-revenue-003', 'revenue', 'Sponsoring Demo Banque', 'sponsorship', 75000, 75000, 75000, 'EUR', 'actual', 'Recette fictive liée au sponsor.', 'demo@komuno.fr', 'demo@komuno.fr')
