...
|---------|---------|------|
| Next.js | 16.1.4 | ✅ À jour (Turbopack activé) |
| NestJS | 11.1.9 | ✅ À jour |
| Zod | v4.3.6 | ✅ À jour |
| API | REST + TanStack Query | ✅ tRPC jamais implémenté — stack REST native |

### Tâche Restante

**DONE:** Next.js 16 + Turbopack, Zod v4, stack REST (tRPC jamais implémenté)
...
**4. [ ] Ajouter @nestjs/swagger pour OpenAPI** (optionnel, quand besoin)
