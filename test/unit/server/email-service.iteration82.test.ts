...
describe('server/email-service.js (iteration 82)', () => {
  it('sendEmail retourne Service email non configuré sans init SMTP', async () => {
    ...
    const result = await emailService.sendEmail({ to: ['user@example.com'], subject: 'Sujet', html: '<p>Body</p>' });
