...
describe('server/email-notification-service.js iteration136', () => {
  it('queries recruitment manager with RESPONSABLE_RECRUTEMENT role constant', async () => {
    ...
    expect(storageMock.getMemberByCjdRole).toHaveBeenCalledWith('RESPONSABLE_RECRUTEMENT');
  });
});
