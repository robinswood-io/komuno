...
describe('server/email-notification-service.js iteration117', () => {
  it('returns success without send when loan-item recipients collapse to empty after normalization', async () => {
    ...
    const result = await emailNotificationService.notifyNewLoanItem({ title: 'Projector' });
