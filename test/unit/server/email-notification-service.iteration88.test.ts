...
describe('server/email-notification-service.js iteration88', () => {
  it('returns explicit error when testEmailConfiguration finds no active admin', async () => {
    setupDependencies({
      adminsResult: { success: true, data: [] },
    });
