...
describe('server/email-notification-service.js iteration128', () => {
  it('returns explicit no-admin error in testEmailConfiguration after trimming empty active emails', async () => {
    ...
    expect(String(result.error?.message)).toContain('Aucun administrateur actif trouvé pour le test');
