...
describe('server/email-service.js (iteration 66)', () => {
  beforeEach(() => {
  ...
  it('parse un SMTP_PORT avec zéros en tête et en déduit secure=true sur 465', async () => {
    process.env.SMTP_PORT = '00465';
    process.env.SMTP_USER = 'env-user';
    process.env.SMTP_PASSWORD = 'env-pass';
