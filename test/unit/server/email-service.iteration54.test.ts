...
describe('server/email-service.js (iteration 54)', () => {
  beforeEach(() => {
  ...
  it('verifyConnection retourne true et loggue en info quand verify réussit', async () => {
    process.env.SMTP_USER = 'env-user';
    process.env.SMTP_PASSWORD = 'env-pass';
    ...
    expect(loggerMock.info).toHaveBeenCalledWith('[Email] Connexion SMTP vérifiée');
  });
});
