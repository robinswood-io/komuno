    ...
    try {
      ...
      const result = await db
        .select({
          ...
          originOrganizationId: events.originOrganizationId,
          sourceEventId: events.sourceEventId,
          sourceInstanceUrl: events.sourceInstanceUrl,
          federationVisibility: events.federationVisibility,
          federationStatus: events.federationStatus,
          isFederatedCopy: events.isFederatedCopy,
          canonicalEventId: events.canonicalEventId,
