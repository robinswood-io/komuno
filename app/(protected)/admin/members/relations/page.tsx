...
import { RelationGraphView } from '@/components/admin/relations/relation-graph-view';
...
import { Loader2, Plus, Network, TableIcon } from 'lucide-react';

// Importer le contenu du tableau existant depuis l'ancien fichier
// Pour simplifier, je vais créer un composant séparé pour le tableau
import { RelationsTable } from '@/components/admin/relations/relations-table';

/**
 * Page Gestion des Relations - Version avec graphe interactif
 */
